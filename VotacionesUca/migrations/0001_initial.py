    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('censo', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='Censo.Censo')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('censo', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Censo.Censo')),
                ('pregunta', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='VotacionesUca.Pregunta')),
            ],
            bases=('VotacionesUca.procesoelectoral',),
        ),
    ]
